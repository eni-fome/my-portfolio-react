...
const Project = ({ title, description, link1, link2, img }) => {
  ...
  return (
    <motion.div variants={projectVariant} className="relative">
      ...
      <div className="w-[400px] xs:w-[250px] h-[400px] xs:h-[200px] relative">
        <img
          src={img}
          alt={projectTitle}
          className="object-fit w-full h-full  xs:h-[200px] xs:w-[250px]"
        />
      </div>
    </motion.div>
  );
        ...
        >
          ...
          <div
            className="flex justify-center text-center items-center p-10 bg-red
              max-w-[400px] max-h-[400px] text-xl font-playfair font-semibold  xs:h-[200px] xs:w-[250px] "
          >
          ...
          <div
            className="flex justify-center text-center items-center p-10 bg-blue
              max-w-[400px] max-h-[400px] text-2xl font-playfair font-semibold  xs:h-[200px] xs:w-[250px]"
          >
